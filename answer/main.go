...
func initGrpc() {
	flag.Parse()
	serv := flag.String("service", "answer_service", "service name")
	host := flag.String("host", "localhost", "listening host")
	port := flag.String("port", "50002", "listening port")
...
func main() {
	...
	answer.RegisterAnswerServiceServer(grpcServer, &AnswerService{})
